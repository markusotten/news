...
Two vulnerabilities affect NetScaler ADC and Gateway. CVE-2026-19490 is a critical authentication-bypass-using-an-alternate-path flaw letting an unauthenticated remote attacker reach authenticated functionality without valid credentials, on appliances configured as a Gateway (SSL VPN/ICA Proxy/CVPN/RDP Proxy) or AAA virtual server; exact exposure depends on firmware branch/build and, on newer builds, whether a SAML action is configured. CVE-2026-19489 is a memory-overflow bug causing unpredictable behavior or denial-of-service, but only when SIP ALG is enabled on a Large Scale NAT (LSN) group. No exploitation had been reported as of this bulletin. **Update (2026-09-04, reported in the 2026-09-05 daily note):** vulnerability-intelligence firm Previdian reported exploitation attempts against CVE-2026-19490 from three distinct source IPs following publication of a credible proof-of-concept; Belgium's national cybersecurity centre (NCC-BE) separately warned of exploitation attempts the same day. Not yet added to the CISA KEV catalog as of this update. No fix beyond upgrading to 14.1-73.32+ / 13.1-63.21+ is available. **Update (2026-09-10, reported in the 2026-09-11 daily note):** CISA added CVE-2026-19490 to its Known Exploited Vulnerabilities catalog, requiring Federal Civilian Executive Branch agencies to remediate by 2026-09-12. No fix beyond upgrading to 14.1-73.32+ / 13.1-63.21+ is available.

### Citrix Workspace app for Windows Security Bulletin for CVE-2026-78546 and CVE-2026-78547
2026-09-08 · Low-Moderate · [CTX697034](https://support.citrix.com/support-home/kbsearch/article?articleNumber=CTX697034&articleURL=Citrix_Workspace_app_for_Windows_Security_Bulletin_CVE_2026_78546_and_CVE_2026_78547)

Two vulnerabilities affect Citrix Workspace app for Windows. CVE-2026-78546 (CWE-125, out-of-bounds read, CVSS v4.0 4.8) requires local system access to exploit. CVE-2026-78547 (CWE-787, out-of-bounds write, CVSS v4.0 4.4) requires physical access to the device. Affects Current Release before 2603.11 and Long Term Service Release before 2507.1 LTSR CU3 or before 2607 LTSR; fixed in 2603.11 (CR) and 2507.1 LTSR CU3 / 2607 LTSR. No exploitation reported.
